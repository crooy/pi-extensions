 ...
 *
 * Forked from jonjonrankin/pi-caveman with added "mixed" level:
 * emoji, symbols, Dutch/French/German words to shorten things.
 *
 * Commands:
...
const LEVELS = ["off", "lite", "full", "ultra", "mixed", "wenyan-lite", "wenyan", "wenyan-ultra", "micro"] as const;
...
const CAVEMAN_COMMAND_OPTIONS = [
	...
	{ value: "mixed", label: "mixed", description: "Caveman with emoji + 🇳🇱/🇫🇷/🇩🇪 words" },
...
const ANIMATIONS: Record<Exclude<Level, "off">, Animation> = {
	...
	mixed:          { frames: FIRE_FRAMES, label: "MIXED", interval: 180 },
...
Use 🇳🇱/🇫🇷/🇩🇪 words or 🧠⚡🔧 when they save keystrokes.
Example: "New object ref each render. Inline object prop = new ref = re-render. Wrap in \`useMemo\`."`,
