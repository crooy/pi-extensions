/**
 * Configuration module for pi-always-learning.
...
export function loadConfig() {
    ...
    try {
        ...
        console.warn(`[pi-always-learning] Failed to read config.json: ${String(err)}`);
        return { ...DEFAULT_CONFIG };
    }
    let parsed;
    try {
        ...
        console.warn(`[pi-always-learning] Invalid JSON in config.json: ${String(err)}. Using defaults.`);
        return { ...DEFAULT_CONFIG };
    }
