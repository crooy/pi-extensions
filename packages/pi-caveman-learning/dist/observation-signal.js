...
export function scoreObservationBatch(lines, freqContext) {
    let score = 0;
    let errors = 0;
    let corrections = 0;
    let userPrompts = 0;
    ...
    const seenActiveInstincts = new Set();
...
export function isLowSignalBatch(lines, freqContext) {
