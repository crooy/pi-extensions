...
**CAVEMAN STYLE**: Write all instinct titles and actions terse like smart caveman.
- Drop articles (a/an/the), filler words, pleasantries
- Fragments OK. Use → for causality. Start with verb.
- Example: "test db port 3306" not "The test database runs on port 3306"
- Example: "grep→edit: grep first, find context before changing files" not "When modifying code files, always search with grep to find relevant context"
