<p>
  <img src="https://raw.githubusercontent.com/crooy/pi-cavepeople/main/banner.png" alt="pi-cavepeople" width="1100">
</p>

# pi-cavepeople

`pi-cavepeople` lets Pi delegate work to focused caveman-mode child agents. Use it for code review, scouting, implementation, parallel audits, saved workflows, background jobs, and anything else that benefits from a second or third set of model eyes — all with terse caveman responses, fresh shell environments, and direnv support.
