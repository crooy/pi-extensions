...
export class ChainClarifyComponent {
    ...
    renderHeader(text) {
        ...
        return (this.theme.fg("border", "╭" + "─".repeat(padLeft)) +
    ...
    filterModels() {
        ...
        if (!query) {
            ...
            this.filteredModels = this.availableModels.filter((m) => m.fullId.toLowerCase().includes(query) ||
    ...
    filterSkills() {
        ...
        if (!query) {
            ...
            this.filteredSkills = this.availableSkills.filter((s) => s.name.toLowerCase().includes(query) ||
...
//# sourceMappingURL=chain-clarify.js.map