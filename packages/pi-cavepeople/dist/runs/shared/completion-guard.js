...
export function expectsImplementationMutation(agent, task) {
    ...
    if (REVIEW_ONLY_PATTERNS.some((pattern) => pattern.test(taskTextWithoutScopedConstraints)))
        return false;
    if (EXPLICIT_NO_EDIT_PATTERNS.some((pattern) => pattern.test(taskTextWithoutScopedConstraints)))
        return false;
...
//# sourceMappingURL=completion-guard.js.map