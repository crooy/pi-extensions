...
export function formatCodemapMarkdown(codemap) {
    const sections = [
        `## Codebase Map: ${codemap.projectName}`,
        `Generated: ${codemap.generatedAt} | Hash: ${codemap.contentHash}`,
    ];
    if (codemap.directoryTree.length > 0) {
        sections.push("", "### Directory Structure", "```", formatDirectoryTree(codemap.directoryTree), "```");
    }
...
export function truncateCodemap(markdown, maxChars) {
...
//# sourceMappingURL=codemap-formatter.js.map